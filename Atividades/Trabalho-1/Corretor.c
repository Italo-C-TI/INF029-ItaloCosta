...
//  ----- Orienta��es gerais -----
//  Descri��o: esse arquivo cont�m exemplos de testes das quest�es do trabalho.
//  o aluno pode incrementar os testes

//  Copyright � 2016 Renato Novais. All rights reserved.
// �ltima atualiza��o: 19/08/2016 - 12/12/2018

// #################################################

#include <stdio.h>
#include <string.h>
#include "ItaloCosta-20192160019-T1.h"
...
void testQ3()
{
    printf("teste Q3\n");
    char str[250];
    strcpy(str, "Italo Costa Nogueira");
    printf("%d\n", q3(str, 'A', 1) == 0);
    printf("%d\n", q3(str, 'b', 0) == 0);
    printf("%d\n", q3(str, 'i', 1) == 1);
    printf("%d\n", q3(str, 'I', 1) == 1);
